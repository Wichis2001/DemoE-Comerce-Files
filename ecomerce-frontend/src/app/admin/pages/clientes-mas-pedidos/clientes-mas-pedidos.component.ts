...
@Component({
  selector: 'app-clientes-mas-pedidos',
  templateUrl: './clientes-mas-pedidos.component.html',
  styles: [
  ]
})
export class ClientesMasPedidosComponent {

  miFormulario!: FormGroup;
  columnas: string[] = ['No.', 'Nombre Cliente', 'Número de Pedidos'];
  reportes: Reporte[] = [];
  ...
  getProducto(){
    this.reports.get10ClientesMasPedidos( this.currentFechas ).subscribe( res => {
      this.reportes = res;
    });
  }
}
