...
@Component({
  selector: 'app-clientes-mas-ganancias',
  templateUrl: './clientes-mas-ganancias.component.html',
  styles: [
  ]
})
export class ClientesMasGananciasComponent {
  miFormulario!: FormGroup;
  columnas: string[] = ['No.', 'Nombre Cliente', 'Ganancia Generada'];
  reportes: Reporte[] = [];
  ...
  getProducto(){
    this.reports.get5ClientesMasVendidos( this.currentFechas ).subscribe( res => {
      this.reportes = res;
    });
  }
}
